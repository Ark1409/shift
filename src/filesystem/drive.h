...
namespace shift::filesystem {
    ...
    public:
         ...
         */
        static inline drive get_system_drive() noexcept { return drive(); }

        /**
         * Retrieves all logical drives on the system.
         * @return A list of system drives.
         */
        SHIFT_API static std::vector<drive> get_drives() noexcept;

        /**
         * Retrieves the drive letter. This will ALWAYS be in upper case.
         * @return The current drive letter.
         */
        inline char get_letter() const noexcept { return this->m_letter; }

        /**
         * Retrieves validity of the current drive object.
         */
        inline operator bool() const noexcept { return !this->is_invalid(); }

        /**
         * DWORD representation of the drive
         * @see GetLogicalDrives()
         */
        inline DWORD dword_value() const noexcept {
         ...
         */
        inline bool is_invalid() const noexcept { return this->m_letter == 0x0; }

    protected:
        char m_letter = 0x0; // Representing invalid drive
        SHIFT_API drive(char) noexcept; // Drive from letter
    private:
        void m_init(const bool sys = false) noexcept; // Drive initialization
        drive() noexcept; // System drive
    };
