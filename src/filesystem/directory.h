...
namespace shift {
	namespace filesystem {
		...
		public:
			 ...
			 */
			bool operator==(const std::filesystem::path& dir) const noexcept;
			 ...
			 */
			bool mkdir(const bool parents = true) noexcept;
			 ...
			 */
			directory get_parent(void) const { return directory(std::filesystem::absolute(std::filesystem::weakly_canonical(this->m_path)).parent_path()); }
			 ...
			 */
			std::list<directory> get_subdirectories(void) const;
			 ...
			 */
			std::list<file> get_subfiles(void) const;
			 ...
			 */
			std::uintmax_t get_size(void) const;
