...
namespace shift {
    namespace filesystem {
        ...
        public:
            ...
            inline operator std::string() const { return this->get_path(); }

            inline operator const std::filesystem::path&() const noexcept { return this->raw_path(); }

            inline operator std::filesystem::path&() noexcept { return this->raw_path(); }

            SHIFT_API directory get_directory() const;

            SHIFT_API directory get_parent() const;
            ...
            inline std::string get_extension() const { return this->m_path.extension().string(); }

            inline std::string get_path() const { return this->m_path.string(); }
            ...
            inline file get_absolute_file() const { return file(std::filesystem::absolute(this->m_path)); }

            inline file get_canonical_file() const { return file(std::filesystem::weakly_canonical(this->m_path)); }
             ...
             */
            inline std::uintmax_t get_size() const { return std::filesystem::file_size(this->m_path); }
