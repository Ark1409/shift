...
namespace shift::logging {
    SHIFT_API bool enable_colored_console() noexcept {
    ...
    SHIFT_API void disable_colored_console() noexcept {
    ...
    SHIFT_API bool has_colored_console() noexcept {
...
namespace shift::logging {
   SHIFT_API void enable_colored_console() noexcept {}
   SHIFT_API void disable_colored_console() noexcept {}
