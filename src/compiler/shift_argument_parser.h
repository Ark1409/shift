...
namespace shift {
    namespace compiler {
        ...
        public:
            ...
            inline bool contains_argument(const std::string& arg) const noexcept {
                return contains_argument(std::string_view(arg.data(), arg.length()));
            }
            ...
            inline std::vector<std::string_view>& get_arguments() noexcept { return this->m_args; }

            inline const std::vector<std::string_view>& get_arguments() const noexcept { return this->m_args; }

            inline size_t get_size() const noexcept { return this->m_args.size(); }

            inline flags get_flags() const noexcept { return this->m_flags; }

            inline void set_flags(flags const flags_) noexcept { this->m_flags = flags_; }

            inline std::list<filesystem::file>& get_source_files() noexcept { return this->m_compile_files; }

            inline std::list<filesystem::directory>& get_library_paths() noexcept { return this->m_library_paths; }

            inline std::list<filesystem::file>& get_libraries() noexcept { return this->m_libraries; }

            inline const std::list<filesystem::file>& get_source_files() const noexcept { return this->m_compile_files; }

            inline const std::list<filesystem::directory>& get_library_paths() const noexcept { return this->m_library_paths; }

            inline const std::list<filesystem::file>& get_libraries() const noexcept { return this->m_libraries; }

            inline bool is_warnings() const noexcept { return this->has_flag(FLAG_WARNINGS); }

            inline bool is_werrors() const noexcept { return this->has_flag(FLAG_WERROR); }

            inline bool is_cpp_out() const noexcept { return this->has_flag(FLAG_CPP_OUTPUT); }

            inline bool is_help() const noexcept { return this->has_flag(FLAG_HELP); }

            inline bool is_no_std() const noexcept { return this->has_flag(FLAG_NO_STD); }
        ...
        private:
            void resolve_libraries_and_sources();
        };
...
constexpr shift::compiler::argument_parser::flags operator^(const shift::compiler::argument_parser::flags f,
    const shift::compiler::argument_parser::flags other) noexcept {
    return shift::compiler::argument_parser::flags(std::underlying_type_t<shift::compiler::argument_parser::flags>(f) ^
                                                   std::underlying_type_t<shift::compiler::argument_parser::flags>(other));
}

constexpr shift::compiler::argument_parser::flags&
operator^=(shift::compiler::argument_parser::flags& f, const shift::compiler::argument_parser::flags other) noexcept {
...
constexpr shift::compiler::argument_parser::flags operator~(const shift::compiler::argument_parser::flags f) noexcept {
    return shift::compiler::argument_parser::flags(~std::underlying_type_t<shift::compiler::argument_parser::flags>(f));
}
